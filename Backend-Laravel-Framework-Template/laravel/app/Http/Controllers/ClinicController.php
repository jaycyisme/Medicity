...
class ClinicController extends Controller
{
    ...
    public function uploadImage(Request $request)
    {
        try {
            ...
            $fileName = 'clinic_image_' . uniqid() . '.webp';
            ...
            // Lưu ảnh vào storage
            Storage::put('public/Clinic/' . $fileName, $encoded);
        ...
        try {
            ...
            foreach ($uploadedFiles as $file) {
                ...
                $uploadedUrls[] = [
                    ...
                    'image_url' => $fileName,
                    'url' => Storage::url('public/Clinic/' . $fileName),
                ];
            }
    ...
    public function removeImage(Request $request) {
        $imagePath = 'public/Clinic/' . $request->image_url;

        if(Storage::exists($imagePath)) {
            $product_image = ClinicImage::where('image_url', $request->image_url)->first();
            if ($product_image) {
    ...
    {
        $id = $id;
        return view('admin.clinic.edit', compact('id'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        $clinic->delete();
        return redirect()->route('clinic.index')->with('success','Clinic is deleted successfuly.');
    }
