document.addEventListener('DOMContentLoaded', function () {
    ...
    setupImageUpload('thumbnail', 'thumbnailPreview', 'thumbnail_url', '/system-management/disease/upload-image');
    setupImageUpload('doctor_image', 'doctorImagePreview', 'doctor_image_url', '/system-management/doctor/upload-image');
