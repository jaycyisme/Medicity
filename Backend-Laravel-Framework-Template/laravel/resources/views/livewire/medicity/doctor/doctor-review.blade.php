<form wire:submit.prevent="submitReview">
    ...
    <div class="mb-3">
        ...
        <textarea wire:model="review_detail" class="form-control" placeholder="Write your review"></textarea>
        @error('review_detail') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
