                ...
                <div class="mb-5">
                    ...
                    <div wire:ignore class="image-file mt-3 mb-3">
                        ...
                        <div class="image-preview mt-3">
                            <img id="thumbnailPreview" style="width: 30%;" class="img-fluid rounded shadow-sm d-block category-image-preview" src="{{ asset('storage/Blog/' . $thumbnail) }}"/>
                        </div>
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <textarea wire:model="content" id="blog-content-editor" name="blog-content" cols="50" rows="4">{{ $content }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <x-input wire:model='author_name' type="text" class="mb-3" id="author_name" placeholder="Author Name..." required />
                    <x-input-error for="author_name" />

                    <div wire:ignore class="image-file mt-3 mb-3">
                        <x-label class="form-label d-flex align-items-center" value="Main Image" />
                        <input type="file" id="author_image" class="d-none" accept="image/*">
                        <x-input-error for="author_image" />
                        <label class="btn btn-outline-secondary" for="author_image">
                            <i class="ti ti-upload me-2"></i> Click to Upload
                        </label>
                        <div class="image-preview mt-3">
                            <img id="authorImagePreview" style="width: 30%;" class="img-fluid rounded shadow-sm d-block category-image-preview" src="{{ asset('storage/Blog/' . $author_image) }}"/>
                        </div>
                    ...
                    <x-input wire:model='author_overview' type="text" class="mb-3" id="author_overview" placeholder="Author Name..." required />
                    <x-input-error for="author_overview" />
                </div>

                <div class="mb-3">
                    <x-button class="btn-primary">Update Blog</x-button>
                </div>
            </form>
        </div>
    </div>
