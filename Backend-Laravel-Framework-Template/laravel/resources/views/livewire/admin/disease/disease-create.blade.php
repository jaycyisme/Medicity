            ...
            <form wire:submit.prevent="save">
                ...
                <div class="mb-5">
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <div class="card-body">
                                <textarea wire:model="overview" id="overview-content-editor" name="blog-content" cols="50" rows="4"></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <div class="card-body">
                                <textarea wire:model="symptoms" id="symptoms-content-editor" name="blog-content" cols="50" rows="4"></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <div class="card-body">
                                <textarea wire:model="causes" id="causes-content-editor" name="blog-content" cols="50" rows="4"></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <div class="card-body">
                                <textarea wire:model="risk_factors" id="risk-factors-content-editor" name="blog-content" cols="50" rows="4"></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <div class="card-body">
                                <textarea wire:model="diagnosis" id="diagnosis-content-editor" name="blog-content" cols="50" rows="4"></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <div class="card-body">
                                <textarea wire:model="prevention" id="prevention-content-editor" name="blog-content" cols="50" rows="4"></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <div class="card-body">
                                <textarea wire:model="treatment" id="treatment-content-editor" name="blog-content" cols="50" rows="4"></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
                    ...
                    <div wire:ignore class="image-file mt-3 mb-3">
                        ...
                        <div class="image-preview mt-3">
                            <img id="doctorImagePreview" class="img-fluid rounded shadow-sm d-block category-image-preview"/>
                        </div>
                    ...
                    <x-input wire:model='doctor_overview' type="text" class="mb-3" id="doctor_overview" placeholder="Doctor Overview..." required />
                    ...
                    <div wire:ignore class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            ...
                            <div class="card-body">
                                <textarea wire:model="meal_plan" id="meal-plan-content-editor" name="blog-content" cols="50" rows="4"></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
                ...
                <div class="mb-3">
                    <x-button class="btn-primary">Create Disease</x-button>
                </div>
            </form>
        </div>
    </div>
