            ...
            <div class="card-body">
                <form wire:submit.prevent="update">
                    ...
                    <div class="mb-5">
                        ...
                        <div wire:ignore class="image-file mt-3 mb-3">
                            ...
                            <div class="image-preview mt-3">
                                <img src="{{ asset('storage/Clinic/' . $clinic->image_url) }}" id="thumbnailPreview" class="img-fluid rounded shadow-sm d-block category-image-preview" style="width: 100px; height: 100px; object-fit: cover;"/>
                            </div>
                    ...
                    <div wire:ignore class="mb-3">
                        <x-label class="form-label d-flex align-items-center" value="Clinic Image" />
                        <label class="btn btn-outline-secondary" id="uppyModalOpener"><i class="ti ti-upload me-2"></i> Click to upload</label>
                        <div id="uppyArea"></div>
