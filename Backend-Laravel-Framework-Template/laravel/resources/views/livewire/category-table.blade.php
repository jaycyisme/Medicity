                ...
                <td class="align-middle">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="p-1 text-center">
                            <a class="btn btn-sm btn-warning wid-50" href="{{ route('category.show', $category->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Xem">
                        ...
                        {{-- @can('category-edit') --}}
                        <div class="p-1 text-center">
                            <a class="btn btn-sm btn-info wid-50" href="{{ route('category.edit', $category->id) }}">
                                        ...
                                        <label class="form-check-label d-block" for="address-check-1">
                                            <div class="chat-avtar d-inline-flex mx-auto">
                                                <img class="rounded-circle img-fluid wid-90 img-thumbnail"
                                                    src="@if (isset($category->image_url)) {{ asset('storage/Category/' . $category->image_url) }}@else{{ asset('assets/images/user/avatar-1.jpg') }} @endif"
                                                    alt="chillnfree">
                                            </div>
