<div class="table-responsive">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td class="align-middle"><img class="rounded-circle img-fluid wid-60 img-thumbnail" src="@if(isset($clinic->image_url)){{ asset('storage/Clinic/'.$clinic->image_url) }}@else{{ asset('assets/images/user/avatar-1.jpg') }}@endif" alt="medicity"></td>
                <td class="align-middle">{{ $clinic->name }}</td>
                <td class="align-middle">
                    <div class="d-flex align-items-center">
                        {{-- @can('clinic-list') --}}
                        {{-- <div class="p-1 text-center">
                            <a class="btn btn-sm btn-warning wid-50" href="{{ route('clinic.show', $clinic->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Xem">
                        ...
                        {{-- @can('clinic-edit') --}}
                        <div class="p-1 text-center">
                            <a class="btn btn-sm btn-info wid-50" href="{{ route('clinic.edit', $clinic->id) }}">
