                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <select class="select-img">
                                            <option data-image="{{ asset('medicity/assets/img/doctors-dashboard/clinic-01.jpg') }}">The Family Dentistry Clinic</option>
                                            <option data-image="{{ asset('medicity/assets/img/doctors-dashboard/clinic-02.jpg') }}">Dentistry Clinic</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
