													...
													<tbody>
														...
														<tr>
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src="{{ asset('medicity/assets/img/doctors-dashboard/profile-02.jpg') }}" alt="Img">
																	</a>
																	<div class="patient-name-info">
																		<span>#Apt0002</span>
														...
														<tr>
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src="{{ asset('medicity/assets/img/doctors-dashboard/profile-03.jpg') }}" alt="Img">
																	</a>
																	<div class="patient-name-info">
																		<span>#Apt0003</span>
														...
														<tr>
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src="{{ asset('medicity/assets/img/doctors-dashboard/profile-04.jpg') }}" alt="Img">
																	</a>
																	<div class="patient-name-info">
																		<span>#Apt0004</span>
														...
														<tr>
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src="{{ asset('medicity/assets/img/doctors-dashboard/profile-05.jpg') }}" alt="Img">
																	</a>
																	<div class="patient-name-info">
																		<span>#Apt0005</span>
										...
										<div class="upcoming-appointment-card">
											...
											<div class="upcoming-patient-info">
												<div class="info-details">
													<span class="img-avatar"><img src="{{ asset('medicity/assets/img/doctors-dashboard/profile-01.jpg') }}" alt="Img"></span>
													<div class="name-info">
														<span>#Apt0001</span>
												...
												<div class="circle-bg">
													<img src="{{ asset('medicity/assets/img/bg/dashboard-circle-bg.png') }}" alt="Img">
												</div>
											</div>
										...
										<div class="dashboard-card-body">
												...
												<div class="clinic-head">
													<div class="clinic-info">
														<span class="clinic-img">
															<img src="{{ asset('medicity/assets/img/doctors-dashboard/clinic-02.jpg') }}" alt="Img">
														</span>
														<h6>Sofi’s Clinic</h6>
													</div>
											...
											<div class="clinic-available mb-0">
												<div class="clinic-head">
													<div class="clinic-info">
														<span class="clinic-img">
															<img src="{{ asset('medicity/assets/img/doctors-dashboard/clinic-01.jpg') }}" alt="Img">
														</span>
