								...
								{{-- <ul class="header-list-btns">
									...
									<li>
										<div class="view-icons">
											<a href="patient-appointments.html" class="active"><i class="fa-solid fa-list"></i></a>
										</div>
									</li>
									<li>
										<div class="view-icons">
                                    ...
                                    @endphp
                                        ...
                                        <div class="appointment-wrap">
                                            <ul>
                                                ...
                                                <li class="appointment-detail-btn">
                                                    <a href="{{ route('patient-cancelled-appointment', $appointment->id) }}" class="start-link">View Details<i class="fa-regular fa-circle-right ms-1"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!-- /Appointment List -->
                                    ...
                                    @endphp
                                        ...
                                        <div class="appointment-wrap">
                                            <ul>
                                                ...
                                                <li class="appointment-detail-btn">
                                                    <a href="{{ route('patient-completed-appointment', $appointment->id) }}" class="start-link">View Details<i class="fa-regular fa-circle-right ms-1"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!-- /Appointment List -->
