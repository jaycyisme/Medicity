    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between py-3">
                <h5>Create new speciality</h5>
                <a class="btn btn-lg btn-info" href="{{ route('speciality.index') }}">
                    Quay lại
                </a>
            </div>
            <div class="card-body">
                <form class="form" method="POST" action="{{ route('speciality.create') }}">
                    @csrf
                    <div class="mb-5">
                    ...
                    <input type="hidden" name="sub_image_url" id="hidden_sub_image_url" />

                    <div class="mb-3">
                        <x-button class="btn-primary">Tạo danh mục sản phẩm</x-button>
                    </div>
                </form>
            </div>
        </div>
