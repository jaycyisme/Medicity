    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between py-3">
                <h5>Create New Laboratory Test</h5>
                <a class="btn btn-lg btn-info" href="{{ route('laboratory-test.index') }}">
                    Back
                </a>
            </div>
            <div class="card-body">
                <form class="form" method="POST" action="{{ route('laboratory-test.create') }}">
                    @csrf
                    <div class="mb-5">
                        ...
                        <x-input name='price' type="text" class="mb-3" id="price" placeholder="Price..." required />
