        ...
        <div class="row align-items-center" style="margin-top: 100px;">
            <div class="col-lg-6">
                <div class="banner-content aos" data-aos="fade-up">
                    ...
                    <div class="banner-form-field">
                        <form action="https://doccure.dreamstechnologies.com/html/template/index-13.html">
                            <div class="input-box">
            ...
            <div class="col-lg-6">
                <div class="banner-sec-img">
                    <span><img src="{{ asset('medicity/assets/img/banner-img-13.png') }}" class="img-fluid" alt="Img"></span>
                    <span class="banner-curve aos" data-aos="fade-up" data-aos-delay="500"><img src="{{ asset('medicity/assets/img/banner-img-curve-13.png') }}" class="img-fluid" alt="Img"></span>
                    <span class="banner-round-bg"><img src="{{ asset('medicity/assets/img/banner-round-vector-13.png') }}" alt="Img"></span>
                    <span class="lief-img"><img src="{{ asset('medicity/assets/img/banner-lief-img.png') }}" alt="Img"></span>
                    <span class="banner-curve-two"><img src="{{ asset('medicity/assets/img/banner-curve-bg.png') }}" alt="Img"></span>
                    <span class="chat-call-btn"><a href="chat-doctor.html">Chat and Call Now</a></span>
                    <div class="banner-cal-icon">
                        <span class="calender-border"><img src="{{ asset('medicity/assets/img/icons/banner-cal-icon.svg') }}" alt="Img"></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-7 col-lg-8">
                <ul class="work-flow-chart">
                    <li data-aos="fade-up" data-aos-delay="500">
                        <img src="{{ asset('medicity/assets/img/bg/chart-arrow-3.png') }}" alt="Img">
                        <div class="flow-chart-list">
                            <span class="chart-icon"><img src="{{ asset('medicity/assets/img/icons/flow-chart-icon-01.svg') }}" alt="Img"></span>
                            <h6>Location</h6>
                            <span class="chart-count">01</span>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="600">
                        <img src="{{ asset('medicity/assets/img/bg/chart-arrow-01.png') }}" alt="Img">
                        <div class="flow-chart-list bg-yelllow">
                            <span class="chart-icon"><img src="{{ asset('medicity/assets/img/icons/flow-chart-icon-02.svg') }}" alt="Img"></span>
                            <h6>Booking</h6>
                    ...
                    <li data-aos="fade-up" data-aos-delay="700">
                        <img src="{{ asset('medicity/assets/img/bg/chart-arrow-3.png') }}" alt="Img">
                        <div class="flow-chart-list">
                            <span class="chart-icon"><img src="{{ asset('medicity/assets/img/icons/flow-chart-icon-03.svg') }}" alt="Img"></span>
                            <h6>Caregiver</h6>
                            <span class="chart-count">03</span>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="800">
                        <img src="{{ asset('medicity/assets/img/bg/chart-arrow-02.png') }}" alt="Img">
                        <div class="flow-chart-list bg-yelllow">
                            <span class="chart-icon"><img src="{{ asset('medicity/assets/img/icons/flow-chart-icon-04.svg') }}" alt="Img"></span>
                            <h6>Takecare</h6>
...
<section class="service-sec-fourteen">
    <div class="section-bg">
        <img src="{{ asset('medicity/assets/img/bg/sercice-sec-bg.png') }}" alt="Img">
    </div>
    <div class="container">
                ...
                <div class="service-type-cards w-100">
                    <div class="service-types" data-aos="fade-down">
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-01.jpg') }}" alt="Img"></a>
                        </div>
                        <div class="service-content">
                            <h4><a href="search-2.html">Nurse at Home</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                    </div>
                    <div class="service-types" data-aos="fade-down">
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-02.jpg') }}" alt="Img"></a>
                        </div>
                        <div class="service-content">
                            <h4><a href="search-2.html">Mobility Assistance</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                    </div>
                    <div class="service-types" data-aos="fade-down">
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-03.jpg') }}" alt="Img"></a>
                        </div>
                        <div class="service-content">
                            <h4><a href="search-2.html">Physiotherapy</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                    </div>
                    <div class="service-types" data-aos="fade-down">
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-04.jpg') }}" alt="Img"></a>
                        </div>
                        <div class="service-content">
                            <h4><a href="search-2.html">Medical Equipment</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                    </div>
                    <div class="service-types" data-aos="fade-down">
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-05.jpg') }}" alt="Img"></a>
                        </div>
                        <div class="service-content">
                            <h4><a href="search-2.html">Trained Attendants</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex">
                <div class="services-img-col w-100">
                    <div class="sec-img-center">
                        <img src="{{ asset('medicity/assets/img/service/service-img.jpg') }}" alt="Img">
                    </div>
                    <div class="img-center img-center-one" data-aos="fade-down" data-aos-delay="500">
                        <img src="{{ asset('medicity/assets/img/service/service-img-01.jpg') }}" alt="Img">
                    </div>
                    <div class="img-center img-center-two" data-aos="fade-up" data-aos-delay="800">
                        <img src="{{ asset('medicity/assets/img/service/service-img-02.jpg') }}" alt="Img">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-12 d-flex">
                <div class="service-type-cards w-100">
                    <div class="service-types service-type-right" data-aos="fade-down">
                        <div class="service-content">
                            <h4><a href="search-2.html">Lab Tests</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-06.jpg') }}" alt="Img"></a>
                        </div>
                    </div>
                    <div class="service-types service-type-right" data-aos="fade-down">
                        <div class="service-content">
                            <h4><a href="search-2.html">Doctor Consultation</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-07.jpg') }}" alt="Img"></a>
                        </div>
                    </div>
                    <div class="service-types service-type-right" data-aos="fade-down">
                        <div class="service-content">
                            <h4><a href="search-2.html">Mother & Baby Care</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-08.jpg') }}" alt="Img"></a>
                        </div>
                    </div>
                    <div class="service-types service-type-right" data-aos="fade-down">
                        <div class="service-content">
                            <h4><a href="search-2.html">Vaccination</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-09.jpg') }}" alt="Img"></a>
                        </div>
                    </div>
                    <div class="service-types service-type-right" data-aos="fade-down">
                        <div class="service-content">
                            <h4><a href="search-2.html">Tele Consultation</a></h4>
                            <a href="search-2.html" class="explore-link">Explore<i class="feather-arrow-right-circle"></i></a>
                        </div>
                        <div class="doctor-image">
                            <a href="search-2.html"><img src="{{ asset('medicity/assets/img/service/service-doctor-10.jpg') }}" alt="Img"></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="top-nurse-profile-slider owl-carousel">
                    <div class="nurse-profile" data-aos="fade-down">
                        <div class="nurse-img">
                            <a href="doctor-profile.html"><img src="{{ asset('medicity/assets/img/nurses/nurse-04.jpg') }}" alt="Img"></a>
                        ...
                        <div class="nurse-pofile-info">
                            <div class="d-flex justify-content-between nurse-content">
                                <div class="nurse-name">
                                    <h5><a href="doctor-profile.html">Carolyn</a></h5>
                                    <span>United States</span>
                                </div>
                                <span><img src="{{ asset('medicity/assets/img/icons/nurse-slide-badge-01.svg') }}" alt="Img"></span>
                            </div>
                    ...
                    <div class="nurse-profile" data-aos="fade-down">
                        <div class="nurse-img">
                            <a href="doctor-profile.html"><img src="{{ asset('medicity/assets/img/nurses/nurse-05.jpg') }}" alt="Img"></a>
                        ...
                        <div class="nurse-pofile-info">
                            <div class="d-flex justify-content-between nurse-content">
                                <div class="nurse-name">
                                    <h5><a href="doctor-profile.html">Jasmine Madeleine</a></h5>
                                    <span>United States</span>
                                </div>
                                <span><img src="{{ asset('medicity/assets/img/icons/nurse-slide-badge-02.svg') }}" alt="Img"></span>
                            </div>
                            <div class="nurse-details">
                    ...
                    <div class="nurse-profile" data-aos="fade-down">
                        <div class="nurse-img">
                            <a href="doctor-profile.html"><img src="{{ asset('medicity/assets/img/nurses/nurse-06.jpg') }}" alt="Img"></a>
                        ...
                        <div class="nurse-pofile-info">
                            <div class="d-flex justify-content-between nurse-content">
                                <div class="nurse-name">
                                    <h5><a href="doctor-profile.html">Samantha Tracey</a></h5>
                    ...
                    <div class="nurse-profile" data-aos="fade-down">
                        <div class="nurse-img">
                            <a href="doctor-profile.html"><img src="{{ asset('medicity/assets/img/nurses/nurse-01.jpg') }}" alt="Img"></a>
                            <span class="badge">7+ Years Experience</span>
                            <span class="fav-item img-top-item">
                                <a href="javascript:void(0)" class="fav-icon">
                                    <i class="feather-heart"></i>
                        ...
                        <div class="nurse-pofile-info">
                            <div class="d-flex justify-content-between nurse-content">
                                <div class="nurse-name">
                                    <h5><a href="doctor-profile.html">Elizabeth Penelope</a></h5>
                                    <span>United States</span>
                                </div>
                                <span><img src="{{ asset('medicity/assets/img/icons/nurse-slide-badge-01.svg') }}" alt="Img"></span>
                            </div>
                    ...
                    <div class="nurse-profile" data-aos="fade-down">
                        <div class="nurse-img">
                            <a href="doctor-profile.html"><img src="{{ asset('medicity/assets/img/nurses/nurse-02.jpg') }}" alt="Img"></a>
                        ...
                        <div class="nurse-pofile-info">
                            <div class="d-flex justify-content-between nurse-content">
                                <div class="nurse-name">
                                    <h5><a href="doctor-profile.html">Dorothy Joanne</a></h5>
                                    <span>United Kingdom</span>
                                </div>
                                <span><img src="{{ asset('medicity/assets/img/icons/nurse-slide-badge-01.svg') }}" alt="Img"></span>
                            </div>
                    ...
                    <div class="nurse-profile" data-aos="fade-down">
                        <div class="nurse-img">
                            <a href="doctor-profile.html"><img src="{{ asset('medicity/assets/img/nurses/nurse-03.jpg') }}" alt="Img"></a>
                        ...
                        <div class="nurse-pofile-info">
                            <div class="d-flex justify-content-between nurse-content">
                                <div class="nurse-name">
                                    <h5><a href="doctor-profile.html">Rachel Sophie</a></h5>
                                    <span>United States</span>
                                </div>
                                <span><img src="{{ asset('medicity/assets/img/icons/nurse-slide-badge-01.svg') }}" alt="Img"></span>
                            </div>
                ...
                <div class="owl-nav-button">
                    ...
                    <a href="doctor-profile.html" class="view-all">View All Top Nurses</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="best-work-video" data-aos="fade-up">
                        <div class="slider work-video-img">
                            <div class="treatment-video">
                                <div class="video-img">
                                    <img src="{{ asset('medicity/assets/img/slider/video-slider-img-01.jpg') }}" alt="Slider">
                            ...
                            <div class="treatment-video">
                                <div class="video-img">
                                    <img src="{{ asset('medicity/assets/img/slider/video-slider-img-02.jpg') }}" alt="Slider">
                                    <div class="video-player">
                                        <video class="doctor-treatment-video" loop>
                                            <source src="https://media.istockphoto.com/id/1026837780/video/female-doctor-discusses-diagnosis-with-senior-male-patient.mp4?s=mp4-640x640-is&amp;k=20&amp;c=xuEa4-MNFJQTG0rsrImvNp_JSes0bA-ugZEFFVRse9Q=" type="video/mp4">
                                        </video>
                            ...
                            <div class="treatment-video">
                                <div class="video-img">
                                    <img src="{{ asset('medicity/assets/img/slider/video-slider-img-03.jpg') }}" alt="Slider">
                                    <div class="video-player">
                                        <video class="doctor-treatment-video" loop>
                                            <source src="https://media.istockphoto.com/id/1026837780/video/female-doctor-discusses-diagnosis-with-senior-male-patient.mp4?s=mp4-640x640-is&amp;k=20&amp;c=xuEa4-MNFJQTG0rsrImvNp_JSes0bA-ugZEFFVRse9Q=" type="video/mp4">
                                        </video>
                            ...
                            <div class="treatment-video">
                                <div class="video-img">
                                    <img src="{{ asset('medicity/assets/img/slider/video-slider-img-04.jpg') }}" alt="Slider">
                                    <div class="video-player">
                                        <video class="doctor-treatment-video" loop>
                                            <source src="https://media.istockphoto.com/id/1026837780/video/female-doctor-discusses-diagnosis-with-senior-male-patient.mp4?s=mp4-640x640-is&amp;k=20&amp;c=xuEa4-MNFJQTG0rsrImvNp_JSes0bA-ugZEFFVRse9Q=" type="video/mp4">
                                        </video>
                        ...
                        <div class="slider slider-thumbnails-img">
                            <div class="slider-small-thumb">
                                <div class="small-slide-img"><img src="{{ asset('medicity/assets/img/slider/video-slider-thumb-01.jpg') }}" alt="product image"></div>
                                <a href="javascript:void(0);" class="play-btn-small"><i class="feather-play"></i></a>
                            </div>
                            <div class="slider-small-thumb">
                                <div class="small-slide-img"><img src="{{ asset('medicity/assets/img/slider/video-slider-thumb-02.jpg') }}" alt="product image"></div>
                                <a href="javascript:void(0);" class="play-btn-small"><i class="feather-play"></i></a>
                            </div>
                            <div class="slider-small-thumb">
                                <div class="small-slide-img"><img src="{{ asset('medicity/assets/img/slider/video-slider-thumb-03.jpg') }}" alt="product image"></div>
                                <a href="javascript:void(0);" class="play-btn-small"><i class="feather-play"></i></a>
                            </div>
                            <div class="slider-small-thumb">
                                <div class="small-slide-img"><img src="{{ asset('medicity/assets/img/slider/video-slider-thumb-03.jpg') }}" alt="product image"></div>
...
<section class="our-blog-fourteen">
    <div class="section-bg">
        <img src="{{ asset('medicity/assets/img/bg/blog-bg-14.png') }}" alt="Img">
    </div>
    <div class="container">
        <div class="section-head-fourteen">
                        ...
                        <div class="blog-slide-fourteen owl-carousel">
                            <div class="blog-grid-fourteen" data-aos="fade-up" data-aos-delay="500">
                                <div class="blog-grig-img">
                                    <a href="blog-details.html"><img src="{{ asset('medicity/assets/img/blog/blog-18.jpg') }}" alt="Img"></a>
                                </div>
                            ...
                            <div class="blog-grid-fourteen" data-aos="fade-up" data-aos-delay="600">
                                <div class="blog-grig-img">
                                    <a href="blog-details.html"><img src="{{ asset('medicity/assets/img/blog/blog-19.jpg') }}" alt="Img"></a>
                                </div>
                                <div class="blog-grid-content">
                                    <div class="grid-head">
                                    ...
                                    <h4><a href="blog-details.html">Navigating the Transition: A Guide to Choosing the Right Old Age Home</a></h4>
                            ...
                            <div class="blog-grid-fourteen" data-aos="fade-up" data-aos-delay="700">
                                <div class="blog-grig-img">
                                    <a href="blog-details.html"><img src="{{ asset('medicity/assets/img/blog/blog-20.jpg') }}" alt="Img"></a>
                                </div>
                                <div class="blog-grid-content">
                                    <div class="grid-head">
                                    ...
                                    <h4><a href="blog-details.html">Empowering Aging Bodies: The Impact of Physiotherapy in Old Age Home Wellness</a></h4>
            ...
            <div class="owl-nav-button">
                ...
                <a href="blog-grid.html" class="view-all">View All Blogs</a>
            </div>
    </div>
</section>
<!-- /Blog Section -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="price-plane-card">
                        ...
                        <div class="plane-btn">
                            <a href="login-email.html" class="btn btn-primary w-100">Choose Plans</a>
                        </div>
                    </div>
                </div>
